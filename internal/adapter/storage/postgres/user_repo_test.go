...
import (
	...
	"gitlab.otovinn.com/Gateway/internal/core/domain/entity"
	"gitlab.otovinn.com/Gateway/internal/core/port/db"
	"gitlab.otovinn.com/Gateway/internal/core/port/user"
	"gitlab.otovinn.com/Gateway/internal/core/util"
	"log"
	"testing"
	"time"
)
...
func TestGetByID(t *testing.T) {
	...
	testCases := []struct {
		name   string
		setup  func(repo user.UserRepositoryPort) (*string, error)
		input  *entity.User
		errors bool
	}{
		{
