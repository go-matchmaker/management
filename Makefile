BINARY_NAME := otovinn-management
...
GRPC_GATEWAY_PLUGIN := protoc-gen-grpc-management
...
DB_URL := postgresql://postgres:pass@localhost:5432/management?sslmode=disable
# ==================================================================================== #
# DB
# ==================================================================================== #
create-db:
...
.PHONY: test-paseto
test-paseto:
	go test ./internal/adapter/management/paseto/... -v
...
run-http:
    ...
    CGO_ENABLED=0 go run management/$(HTTP_MAIN_PACKAGE_PATH)
